      ...
      <div class="grid-container">
        ...
        <div class="form-section">
          ...
          <div ref="step4" id="step4" class="step-container">
            <div class="bag-input">
              <p class="section-title">여행가방 종류 및 수량</p>
              <div class="bag-list">
                <div
          ...
          <div ref="step5" id="step5" class="step-container">
            <div class="button">
              <button class="reser" @click="submitReservation()">
                예약하기
              </button>
            </div>
          </div>
